...
| **Native** | You | AI, after you ask — and the app rearranges | Same terminal. Native adds tabs / screens, then a second ask: keep the tab as a default, or buy any of the names? You confirm orders. |
| **Trading agent** | The system | AI, then you | Situation first. Evidence. Tickets already drafted (or none at close). Ask is a back pocket. You confirm. |
...
**Trading agent headline:** Quiet open. You are still net long.

**Trading agent tickets (already there):** Protective put (buy 23,100 PE) · Put spread (cheaper, capped).
...
**Why this moment:** Trading agent value at a *quiet* open is optional hedges without a prompt. Traditional looks fine because nothing is on fire — that is the trap.
...
**Trading agent headline:** Downside is worse than this morning.

**Trading agent evidence:** One scenario — *if we drop another 100 from here*.

**Trading agent tickets:** Buy 23,100 PE (stay in, shock absorber) · Flatten futures (exit the long).
...
**Trading agent headline:** Vol and Banknifty broke. This book is still long NIFTY.

**Trading agent evidence:** Three names — NIFTY, BANKNIFTY, India VIX.

**Trading agent tickets:** Same pair (put · flatten) on purpose. The choice did not change; the reason did.
...
**Trading agent headline:** The 23,600 CE is no longer a cushion.

**Trading agent evidence:** Chain slice with 23,600 marked.

**Trading agent tickets:** Buy back 23,600 CE · Roll to 23,800 CE.
...
**Trading agent headline:** The day versus the 09:15 plan.

**Trading agent evidence:** Attribution — each leg’s MTM at 09:15 vs now. **No ticket.**
...
4. Open **Trading agent**. Situation and tickets (or attribution) are already there. Ask only if you disagree.
5. Score on Trading agent: *Would you rather this than the other two, for this moment?*

Do not auto-fire. Do not treat chips as the Trading agent plot. Trading agent stays system-started.
