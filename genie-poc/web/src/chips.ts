...
export const COPILOT_CHIPS: { label: string; prompt: string }[] = [
  {
    ...
    prompt:
      "Create a NEW Watchlist tab on the app. Do not replace any tab that is already open. Do not paste the table in chat. Then ask if I want to keep it after this session as a default.",
  },
  {
  ...
  },
  {
    label: "Lowest PB",
    prompt:
      "Screen the 10 lowest price-to-book names. Sort PB ascending. Open a Screener tab. Then ask if I want to buy any of them.",
  },
  {
